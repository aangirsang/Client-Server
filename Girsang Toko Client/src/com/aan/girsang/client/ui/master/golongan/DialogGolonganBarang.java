 ...
 * @author GIRSANG PC
 */
public class DialogGolonganBarang extends javax.swing.JDialog {
    ...
    public GolonganBarang showDialog(GolonganBarang k, String Title) {
        ...
        if (k == null) {
            clear();
            txtId.setText(ClientLauncher.getConstantService().ambilBerikutnya(
                    MasterRunningNumberEnum.GOLONGAN));
        } else {
            golonganBarang = ClientLauncher.getMasterService().cariID(k.getId());
