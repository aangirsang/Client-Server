...
public class PanelPelanggan extends javax.swing.JPanel {
    ...
    private void ukuranTabelProduk() {
        ...
        tabel.getColumnModel().getColumn(2).setPreferredWidth(250);//Alamat
        ...
        tabel.getColumnModel().getColumn(6).setPreferredWidth(100);//Email
        tabel.getColumnModel().getColumn(7).setPreferredWidth(100);//Kota
    }
    private void cari(){
        pelanggan = new Pelanggan();
        pelanggan = ClientLauncher.getMasterService().cariIdPelanggan(idSelect);
    }
