 ...
 * @author ITSUSAHBRO
 */
public class PilihGolonganBarang extends javax.swing.JDialog {
    ...
    private void initListener() {
            ...
            public void mouseClicked(MouseEvent mE) {
                if (mE.getClickCount() == 2) {
                    if (id == null) {
                        ...
                        golonganBarang = ClientLauncher.getMasterService().cariID(id);
                        dispose();
        ...
        toolBarSelect1.getTxtCari().addKeyListener(new KeyListener() {
            ...
            public void keyReleased(KeyEvent ke) {
                if ("".equals(toolBarSelect1.getTxtCari().getText())) {
                    ...
                    golonganBarangs = ClientLauncher.getMasterService().cariNama(toolBarSelect1.getTxtCari().getText());
                    tblGolonganBarang.setModel(new kategoriTabelModel(golonganBarangs));
        ...
        toolBarSelect1.getBtnBaru().addActionListener((ActionEvent ae) -> {
            ...
            GolonganBarang g = new DialogGolonganBarang().showDialog(golonganBarang, judul);
