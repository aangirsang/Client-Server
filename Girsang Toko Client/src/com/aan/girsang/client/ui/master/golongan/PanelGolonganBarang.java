 ...
 */
package com.aan.girsang.client.ui.master.golongan;
 ...
 * @author ITSUSAHBRO
 */
public class PanelGolonganBarang extends javax.swing.JPanel {
    ...
    private void isiTabelKategori() {
        golonganBarangs = ClientLauncher.getMasterService().semua();
    ...
    private void cariSelect() {
        ...
        golonganBarang = ClientLauncher.getMasterService().cariID(idSelect);
    }
    ...
    private void initListener() {
            ...
            public void mouseClicked(MouseEvent me) {
                if (me.getClickCount() == 2) {
                    ...
                    if ("".equals(idSelect)) {
                        ...
                        cariSelect();
                        GolonganBarang g = new DialogGolonganBarang().showDialog(golonganBarang, title);
                        golonganBarang = new GolonganBarang();
                        if (g != null) {
                            golonganBarang.setId(g.getId());
                            golonganBarang.setGolonganBarang(g.getGolonganBarang());

                            ClientLauncher.getMasterService().simpan(golonganBarang);
                            isiTabelKategori();
        ...
        toolbar.getTxtCari().addKeyListener(new KeyListener() {
            ...
            public void keyReleased(KeyEvent ke) {
                if ("".equals(toolbar.getTxtCari().getText())) {
                    ...
                    golonganBarangs = ClientLauncher.getMasterService().cariNama(toolbar.getTxtCari().getText());
                    tbGolonganBarang.setModel(new kategoriTabelModel(golonganBarangs));
                    RowSorter<TableModel> sorter = new TableRowSorter<>(new kategoriTabelModel(golonganBarangs));
                    tbGolonganBarang.setRowSorter(sorter);
                    ukuranTabelBarang();
        ...
        toolbar.getBtnBaru().addActionListener((ActionEvent ae) -> {
            ...
            GolonganBarang k = new DialogGolonganBarang().showDialog(golonganBarang, title);
            golonganBarang = new GolonganBarang();
            if (k != null) {
        ...
        toolbar.getBtnHapus().addActionListener((ActionEvent ae) -> {
            if (golonganBarang == null) {
                ...
                ClientLauncher.getMasterService().hapus(golonganBarang);
                isiTabelKategori();
