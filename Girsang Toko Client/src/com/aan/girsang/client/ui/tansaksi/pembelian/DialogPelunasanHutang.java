 ...
 * @author GIRSANG PC
 */
public class DialogPelunasanHutang extends javax.swing.JDialog {
    ...
    private void clearAll(){
        txtNoRef.setText(ClientLauncher.getConstantService().ambilBerikutnya(TransaksiRunningNumberEnum.HUTANG));
    ...
    private void loadModelToForm(PelunasanHutang p){
        ...
        daftarPelunasanHutangDetail = ClientLauncher.getTransaksiService().cariDetail(p);
    ...
    private void tampilDetails(Supplier s){
        ...
        if (s != null) {
            ...
            List<Pembelian> hutangPembelian = ClientLauncher.getTransaksiService().hutangPembelian(s);

            BigDecimal totalHutang = new BigDecimal(0);
            BigDecimal totalPembayaran;
            for(Pembelian beli : hutangPembelian){
                List<PelunasanHutangDetail> pelunasanHutangs = ClientLauncher.getTransaksiService().cariPembelian(beli);
    ...
    private void loadFormToModel(){
        ...
        pelunasanHutang.setPembuat(ClientLauncher.getPenggunaAktif());
    ...
    private void initComponents() {
        ...
        jLabel1.setText(org.openide.util.NbBundle.getMessage(DialogPelunasanHutang.class, "DialogPelunasanHutang.jLabel1.text")); // NOI18N

        jLabel2.setText(org.openide.util.NbBundle.getMessage(DialogPelunasanHutang.class, "DialogPelunasanHutang.jLabel2.text")); // NOI18N

        jLabel3.setText(org.openide.util.NbBundle.getMessage(DialogPelunasanHutang.class, "DialogPelunasanHutang.jLabel3.text")); // NOI18N

        jLabel4.setText(org.openide.util.NbBundle.getMessage(DialogPelunasanHutang.class, "DialogPelunasanHutang.jLabel4.text")); // NOI18N

        txtKwitansi.setText(org.openide.util.NbBundle.getMessage(DialogPelunasanHutang.class, "DialogPelunasanHutang.txtKwitansi.text")); // NOI18N

        txtKodeSupplier.setText(org.openide.util.NbBundle.getMessage(DialogPelunasanHutang.class, "DialogPelunasanHutang.txtKodeSupplier.text")); // NOI18N
        ...
        txtNamaSupplier.setText(org.openide.util.NbBundle.getMessage(DialogPelunasanHutang.class, "DialogPelunasanHutang.txtNamaSupplier.text")); // NOI18N
        ...
        if (table.getColumnModel().getColumnCount() > 0) {
            table.getColumnModel().getColumn(0).setHeaderValue(org.openide.util.NbBundle.getMessage(DialogPelunasanHutang.class, "DialogPelunasanHutang.table.columnModel.title0")); // NOI18N
            table.getColumnModel().getColumn(1).setHeaderValue(org.openide.util.NbBundle.getMessage(DialogPelunasanHutang.class, "DialogPelunasanHutang.table.columnModel.title1")); // NOI18N
            table.getColumnModel().getColumn(2).setHeaderValue(org.openide.util.NbBundle.getMessage(DialogPelunasanHutang.class, "DialogPelunasanHutang.table.columnModel.title2")); // NOI18N
            table.getColumnModel().getColumn(3).setHeaderValue(org.openide.util.NbBundle.getMessage(DialogPelunasanHutang.class, "DialogPelunasanHutang.table.columnModel.title3")); // NOI18N
            table.getColumnModel().getColumn(4).setHeaderValue(org.openide.util.NbBundle.getMessage(DialogPelunasanHutang.class, "DialogPelunasanHutang.table.columnModel.title4")); // NOI18N
            table.getColumnModel().getColumn(5).setHeaderValue(org.openide.util.NbBundle.getMessage(DialogPelunasanHutang.class, "DialogPelunasanHutang.table.columnModel.title5")); // NOI18N
        }

        jButton1.setText(org.openide.util.NbBundle.getMessage(DialogPelunasanHutang.class, "DialogPelunasanHutang.jButton1.text")); // NOI18N
        ...
        jButton3.setText(org.openide.util.NbBundle.getMessage(DialogPelunasanHutang.class, "DialogPelunasanHutang.jButton3.text")); // NOI18N
        ...
        txtNoRef.setText(org.openide.util.NbBundle.getMessage(DialogPelunasanHutang.class, "DialogPelunasanHutang.txtNoRef.text")); // NOI18N

        lblKeterangan.setHorizontalAlignment(javax.swing.SwingConstants.RIGHT);
        lblKeterangan.setText(org.openide.util.NbBundle.getMessage(DialogPelunasanHutang.class, "DialogPelunasanHutang.lblKeterangan.text")); // NOI18N
