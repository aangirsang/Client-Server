...
import com.aan.girsang.client.ui.security.tingkatAkses.PilihTingkatAkses;
...
public class DialogPengguna extends javax.swing.JDialog {
    ...
    private void clear(){
        txtId.setText(ClientLauncher.getConstantService().ambilBerikutnya(MasterRunningNumberEnum.PENGGUNA));
        txtUserName.setText("");
    ...
    private void isiComboTingkatAkses() {
        ...
        daftarTingkatAkses = ClientLauncher.getSecurityService().semuaTingkatAkses();
